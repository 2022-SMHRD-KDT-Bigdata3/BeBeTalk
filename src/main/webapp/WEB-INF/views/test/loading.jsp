...
<head>
    ...
    <!--로딩페이지 20초 후에 결과페이지로 이동하자!-->
    <meta http-equiv="refresh" content="20; url='test_check.html'">
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="kids_select.html"
                            style="font-size: 1em;color: black;">test</a></li>
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="mypage.html"
                            style="font-size: 1em;color: black;">mypage</a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <h3 style="text-align: center; color:  #2e3228">테스트 결과를 분석중입니다.</h3>
                    <div>
                <div>
            </div>
        </article>
