        ...
        <div class="header_white"></div>
            ...
            <br><br>
             ...
             <div class="container" style="width: 2400px;">
                ...
                <h3 style="text-align: center; margin-left: 100px; margin-right: 100px;  color: black;  font-family: 'GangwonEdu_OTFBoldA';" >바닷속에는 알록달록~한 물고기들이 많아요🐠</h3>
             </div>
            <!-- 음성검사하기 버튼-->
        ...
        <div class="carousel-item active" style="background-image: url('assets/img/동화1.jpg')">
          <div class="carousel-caption">
            ...
            <div style="text-align: center;"> 
                <button type="button" class="btn btn-primary btn-login text-uppercase fw-bold" onclick="location.href='${cpath}/testVoice3.do'">
                    다음 →
                </button>
            </div>
    </div>
