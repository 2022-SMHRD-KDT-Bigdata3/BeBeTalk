	...
	function play(){
     ...
     function createDownloadLink(blob) { // 음성 다운로드 함수(blob을 파라미터로 활용)
    	    ...
    	    $.ajax({ //url이 test1-1인 flask로 음성을 보내는 ajax
            	url : "https://bebetalk-flask.ddns.net/test2_2",
            	type : "POST",
            	data : formData,
            	contentType : false,
            	processData : false,
		...
		<body>
			...
			<div class="sound_test">
				...
				<audio id="audio" src="resources/assets/audio/2-2.mp3"></audio>
				...
				<div style="text-align: center;">
					<button type="button"
						...
						onclick="location.href='${cpath}/testVoice2-3.do'">다음 →</button>
				</div>
			</div>
			<br>
