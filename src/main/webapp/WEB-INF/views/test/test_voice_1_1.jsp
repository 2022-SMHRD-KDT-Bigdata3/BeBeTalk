...
<body>
         ...
         <div class="wrapper">
            <div style="padding-top: 40px;">
               <div class="container px- text-center"
                  ...
                  <div class="row">
                     <div class="col">
                        <div class="step-box1">1. 자녀 선택</div>
                     </div>
                     <div class="col">
                     ...
                     <div class="col">
                        <div class="step-box4">4. 결과 보기</div>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="sound_test">
            ...
            <audio id="audio" src="resources/assets/audio/1-1.mp3"></audio>
            ...
            <div style="text-align: center;">
               <button type="button"
                  ...
                  onclick="location.href='${cpath}/testVoice1-2.do'">다음 →</button>
            </div>
         </div>
         <br>
