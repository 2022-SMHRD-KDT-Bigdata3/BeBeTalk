   ...
   <!-- 20초후에 페이지 이동 --><!--<meta http-equiv="refresh" content="30; url='${cpath}/testCheck.do'">  -->
...
<script type="text/javascript"> 
    ...
    /* $(function() {
     ...
     function createDownloadLink(blob) { // 음성 다운로드 함수(blob을 파라미터로 활용)
           ...
           $.ajax({ //url이 test1-1인 flask로 음성을 보내는 ajax
               url : "http://127.0.0.1:5001/test1_3",
               type : "POST",
               data : formData,
               contentType : false,
               processData : false,
   ...
   <body>
      ...
      <div class="sound_test">
         ...
         <audio id="audio" src="resources/assets/audio/1-3.mp3"></audio>
       ...
       <div class="carousel-inner">
         ...
         <div style="text-align: center;">
            <button id="lodingBtn" type="button"
               ...
               onclick="location.href='${cpath}/testCheck.do'">다음 →</button>
         </div>
      </div>
      <br>
