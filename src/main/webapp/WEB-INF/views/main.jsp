...
<link rel="icon" type="image/x-icon"
	href="${cpath}/resources/assets/favicon.ico" />
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
		<div class="container px-4 px-lg-5">
			<a class="navbar-brand" href="main copy.html"
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<c:if test="${!empty uvo}">
					<li class="nav-item">
						<a class="nav-link px-lg-3 py-3 py-lg-4" href="${cpath}/testStart.do" style="font-size: 1em; color: rgb(2, 50, 4);">Test</a>
					</li>
					<li class="nav-item">
			...
			<c:if test="${empty uvo}">
				<li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4"
						href="${cpath}/login.do" style="font-size: 1em; color: rgb(2, 50, 4);">Login</a></li>
			</c:if>
				</ul>
			</div>
		</div>
	...
	<!-- 헤더이미지+ 내용 애니메이션 효과-->
	<header class="masthead10"
		style="background-image: url('${cpath}/resources/assets/img/메인페이지_헤더(현재).jpg');">
				...
				<div class="col-md-10 col-lg-8 col-xl-7">
					<div class="page-heading">
						<div style="text-align: left; font-family: 'GangwonEdu_OTFBoldA';">
							<p
								style="color: darkgreen; text-align: left; margin-bottom: 0% !important;">
								<span class="bbt">B</span> <span class="bbt">E</span> <span
									class="bbt">B</span> <span class="bbt">E</span> <span
									class="bbt">T</span> <span class="bbt">A</span> <span
									class="bbt">L</span> <span class="bbt">K</span>
							</p>
						</div>
	...
	<section id="scroll">
		<div style="background-color: rgb(158, 201, 84)">
			<section class="content-section bg-primary1 text-white text-center"
				id="services" style="background-color: #008000 rgb(0, 128, 0);">
				<div class="container px-4 px-lg-5"
		...
		<header class="masthead"
			style="background-image: url('${cpath}/resources/assets/img/메인페이지_아래2.jpg')">
		</header>
