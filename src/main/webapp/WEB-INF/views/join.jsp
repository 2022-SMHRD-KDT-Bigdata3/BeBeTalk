            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                      <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="kids_select.html"  style="font-size: 1em;color: rgb(2, 50, 4);">Test</a></li>
          ...
          <div class="card-body p-4 p-sm-5">
            ...
            <form>
              ...
              <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInputUsername" placeholder="ID를 입력해주세요" required autofocus>
              ...
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingInputUsername" placeholder="이름" required autofocus>
            ...
            <br>
              <div class="d-block text-center mt-2 small">
                <button type="submit" class="btn btn-primary btn-login text-uppercase fw-bold">회원가입 완료</button>
              </div>
