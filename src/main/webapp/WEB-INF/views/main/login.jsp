            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="${cpath}/join.do" style="font-size: 1em;color: black;">join</a></li>
                    </ul>
                </div>
            </div>
        </nav>
              ...
              <div class="card-body p-4 p-sm-5">
                ...
                <!-- 아이디, 패스워드 파라미터 값을 login.do로 post방식으로 요청 -->
                  ...
                  <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" value="" id="rememberIdCheck">
                    <label class="form-check-label" for="rememberIdCheck"> Remember ID</label>
                  </div>
                  <div class="d-grid">
                    <button id="loginCheck" class="btn btn-primary btn-login text-uppercase fw-bold" type="button" >로그인</button>
                    <p class="post-meta" style="font-size: medium">회원가입이 되어있지 않으신가요?</p>
                   <button type="button" id="joinBtn" class="btn btn-primary btn-login text-uppercase fw-bold">회원가입</button>
                  </div>
                  <hr class="my-4">
                </form>
              </div>
